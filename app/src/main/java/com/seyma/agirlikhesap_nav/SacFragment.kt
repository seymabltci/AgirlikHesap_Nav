...
import com.seyma.agirlikhesap_nav.databinding.FragmentSacBinding
...
class SacFragment : Fragment() {
    lateinit var binding: FragmentSacBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSacBinding.inflate(inflater, container, false)
        ...
        materyalList.setYogunluk(object : MateryalListesi.OnYogunlukChangeListener{
            override fun onYogunlukChanged(yogunluk: Double){
                ...
                binding.buttonHesapla.setOnClickListener {
                    ...
                    if(yukseklik != null && etKalinligi != null && genislik!= null) {

                        val alan = yukseklik*genislik
                        var agirlik: Double = alan * etKalinligi * yogunluk
                        ...
                        if (adet != null) {
                            ...
                            binding.textViewToplamSonuc.text = "Birim Toplam Ağırlık: $formattedValue2 Kg"
                            binding.textViewToplamSonuc.isVisible = true


                        }

                        binding.textViewSonuc.text = "Ağırlık: $formattedValue Kg"
                ...
                binding.buttonReset.setOnClickListener {
                    ...
                    binding.YukseklikGiris.setText("")
