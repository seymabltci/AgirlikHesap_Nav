...
import com.seyma.agirlikhesap_nav.databinding.FragmentSilmeLamaBinding
import java.math.RoundingMode
import java.text.DecimalFormat
import java.text.DecimalFormatSymbols
class SilmeLamaFragment : Fragment() {

    lateinit var binding: FragmentSilmeLamaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSilmeLamaBinding.inflate(inflater, container, false)
        ...
        materyalList.setYogunluk(object : MateryalListesi.OnYogunlukChangeListener{
            override fun onYogunlukChanged(yogunluk: Double){
                ...
                binding.buttonHesapla.setOnClickListener {
                    ...
                    if(yukseklik != null && uzunluk != null && genislik!= null) {
